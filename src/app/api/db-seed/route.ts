      ...
      const defaultTemplates = [
        {
          ...
          message: "Selamat pagi Bunda! Jangan lupa pantau dan catat perkembangan laktasi si kecil hari ini di asiTrack ya. Tetap semangat, Bunda hebat! 🌸",
          active: true,
        },
        {
          tipe: "afternoon" as const,
          message: "Selamat siang Bunda! Bagaimana kondisi laktasi siang ini? Yuk luangkan waktu sejenak untuk mengisi tracking harian Anda di asiTrack. 💕",
          active: true,
        },
        {
